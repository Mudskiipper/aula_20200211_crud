      ...
      <div class="col-6">
        ...
        <form>
          ...
          <div class="form-group">
            <!-- 3.4 -->
            <input type="text" class="form-control" id="exampleInputLogin1" aria-describedby="text" placeholder="Login" name="login">
          </div> <!-- 3.4 -->
          <br>
          <div class="form-group">
            <!-- 3.5 -->
